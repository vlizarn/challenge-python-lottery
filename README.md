...
The project consists to create a lottery game, using the Object-oriented python programming language that permits user choose the bet mode, input game mode and number of times for 
every bet. Also, permits creating a new bet modes and modifying the current ones.
